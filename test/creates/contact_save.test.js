...
describe('contact_create', () => {
  ...
  describe("when the contact doesn't exist", () => {
    ...
    it('creates the contact and returns its representation', async () => {
      ...
      const results = await appTester(
        App.creates['contact_save'].operation.perform,
        bundle
      );
  ...
  describe("when the contact exists", () => {
    ...
    it('updates the contact and returns its representation', async () => {
      ...
      // mock
      jest.spyOn(intacct.contacts, 'update_contact').mockReturnValue(
        {
          RECORDNO: "22222", 
          CONTACTNAME: bundle.inputData.contactName,
        }
